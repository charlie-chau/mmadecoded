...
def get_fights_with_glicko(db, prob_field, prob_lower, prob_upper, fight_count_min, event_ids):
...
def get_fights_with_glicko_win(db, prob_field, prob_lower, prob_upper, fight_count_min, event_ids):
    fight_with_glicko_col = db['sherdog_fights_with_glicko2']
...
def get_fights_with_glicko_loss(db, prob_field, prob_lower, prob_upper, fight_count_min, event_ids):
    fight_with_glicko_col = db['sherdog_fights_with_glicko2']
                    ...
                    '$or': [
                        {
                            '$and': [
                                ...
                                {
                                    'fighter1_glicko2_info.result': 'LOSS'
                                }
                            ]
                        },
                        {
                            '$and': [
                                ...
                                {
                                    'fighter2_glicko2_info.result': 'LOSS'
                                }
                            ]
                        }
                    ]
...
def get_fights_with_glicko_other(db, prob_field, prob_lower, prob_upper, fight_count_min, event_ids):
    fight_with_glicko_col = db['sherdog_fights_with_glicko2']
...
st.title('Analysis on the effectiveness of Glicko2 with Sherdog data')
...
prob_method = st.selectbox(
    ...
    ['win_prob', 'win_prob_1_5', 'win_prob_2', 'win_prob_2_5', 'win_prob_3'])
...
if min_fight_count and prob_method:
    if organisation is None or organisation == '':
        event_ids_for_organisation = get_event_ids(DB)
    else:
    ...
    for bound in bounds:
        prob_lower = bound[0]
        prob_upper = bound[1]
        total_fights = get_fights_with_glicko(DB, prob_method, prob_lower, prob_upper, min_fight_count, event_ids_for_organisation)
        total_fights_len = len(list(total_fights))

        if total_fights_len > 0:
            fights_win = get_fights_with_glicko_win(DB, prob_method, prob_lower, prob_upper, min_fight_count, event_ids_for_organisation)
            fights_win_len = len(list(fights_win))
            fights_win_pct = (fights_win_len / total_fights_len) * 100

            fights_loss = get_fights_with_glicko_loss(DB, prob_method, prob_lower, prob_upper, min_fight_count, event_ids_for_organisation)
            fights_loss_len = len(list(fights_loss))
            fights_loss_pct = (fights_loss_len / total_fights_len) * 100

            fights_other = get_fights_with_glicko_other(DB, prob_method, prob_lower, prob_upper, min_fight_count, event_ids_for_organisation)
