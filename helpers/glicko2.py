...
class Glicko2(object):
    ...
    def rate_1vs1(self, rating1, rating2, result, drawn=False):
        return (self.rate(rating1, [(DRAW if drawn else result, rating2)]),
                self.rate(rating2, [(DRAW if drawn else (1 - result), rating1)]))
